...
from deep_research_from_scratch.utils import get_today_str, init_local_chat_model, get_structured_output_model
...
writer_model = init_local_chat_model() # model="anthropic:claude-sonnet-4-20250514", max_tokens=64000
...
# Create structured models with local-first strategy and fallback support.
